...
$response=$browser->post("https://commons.wikimedia.org/w/index.php?title=Special:UserLogin&action=submitlogin&type=login",
...
print "Uploading $current_name to the Wikimedia Commons. \nDescription: ";      
	...
	$response=$browser->post("https://commons.wikimedia.org/wiki/Special:Upload",
